...
pub mod my_contract {
    ...
    pub static MYCONTRACT_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "0x6080604052348015600f57600080fd5b50603f80601d6000396000f3fe6080604052600080fdfea26469706673582212201e72ce5cbbcc629d6ece181e9bab4aacf61266b450ffd6694df95221c6d33d0d64736f6c634300080a0033" . parse () . expect ("invalid bytecode")
        });
    ...
    impl<M> std::fmt::Debug for MyContract<M> {
